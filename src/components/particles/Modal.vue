...
const onDragStart = (e: MouseEvent | TouchEvent): void => {
    ...
    if (e instanceof MouseEvent) {
        ...
        pos.value.offsetX = (touch as Touch).clientX - (md_content.value as HTMLElement).offsetLeft;
        pos.value.offsetY = (touch as Touch).clientY - (md_content.value as HTMLElement).offsetTop;
    }
};
...
const onDrag = (e: MouseEvent | TouchEvent): void => {
    ...
    if (e instanceof MouseEvent) {
        ...
        const touch = e.touches[0];
        pos.value.x = (touch as Touch).clientX - pos.value.offsetX;
        pos.value.y = (touch as Touch).clientY - pos.value.offsetY;
    }
    if (md_content.value) {
